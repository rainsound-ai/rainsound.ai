...
pub fn build_tailwind(input: TokenStream) -> TokenStream {
    ...
    eprintln!("Using Tailwind config at {}.", config_str);
    ...
    eprintln!("Using Tailwind input CSS file at {}.", input_file_str);
    ...
    eprintln!("Saving Tailwind output to {}.", output_file_str);
