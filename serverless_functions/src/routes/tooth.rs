...
//
// before
// .corner: before:content-[''] before:absolute before:h-grid-20 before:w-grid-20
// .corner: after:content-[''] after:absolute after:h-grid-20 after:w-grid-20

// .before: before:-top-grid-20, before:shadow-[0_calc(10_*_100vw_/_180)_0_0_#283036]
//
// after
// .after: after:-bottom-grid-20, after:shadow-[0_calc(-10_*_100vw_/_180)_0_0_#283036]
//
...
// 	✅ .corner {
// 		content: '';
// 		@apply absolute h-grid-20 w-grid-20;
// 	}
...
// 	✅ .after {
// 		@apply -bottom-grid-20;
// 		box-shadow: 0 calc(-10 * 100vw / 180) 0 0 #283036;
// 	}

// 	✅ figure.right:before {
// 		@apply corner before left-0 rounded-bl-tooth;
// 	}

// 	✅ figure.right:after {
// 		@apply corner after left-0 rounded-tl-tooth;
// 	}

// 	✅ figure.left:before {
// 		@apply corner before right-0 rounded-br-tooth;
// 	}

// 	✅ figure.left:after {
// 		@apply corner after right-0 rounded-tr-tooth;
// 	}
// </style>
...
// .figure:before {
//      @apply corner -top-grid-20;
// 		box-shadow: 0 calc(10 * 100vw / 180) 0 0 #283036;
// }

// .figure:after {
//      @apply corner -bottom-grid-20;
// 		box-shadow: 0 calc(-10 * 100vw / 180) 0 0 #283036;
// }

// 	✅ figure.right:before {
// 		@apply left-0 rounded-bl-tooth;
// 	}

// 	✅ figure.right:after {
// 		@apply left-0 rounded-tl-tooth;
// 	}

// 	✅ figure.left:before {
// 		@apply right-0 rounded-br-tooth;
// 	}

// 	✅ figure.left:after {
// 		@apply right-0 rounded-tr-tooth;
// 	}
// </style>
